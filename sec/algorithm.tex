...
%\end{equation}
%Recall from \cref{d:index function} that for $\varepsilon \in \Ftwo \cong \{0,1\}$ we have $U^\varepsilon = \ind_U^{-1}(\varepsilon)$.
%Therefore, \eqref{e:pos's equal U's} is equivalent to the function $\ind \colon \overline{a}_{ij} \to \Ftwo$ defined by
%\begin{equation*}
