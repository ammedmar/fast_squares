...
\begin{document}	
	...
	\begin{abstract}
		...
		With mod 2 coefficients, Steenrod squares are the most important of such operations, and effective methods for their computation rely on the chain level structure defined by cup-$i$ coproducts.
		These are important in their own right, having connections to, among others, category theory, convex geometry and lattice field theory.
