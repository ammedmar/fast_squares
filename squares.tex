...
\section{Cup-$i$ constructions and Steenrod squares} \label{s:squares}
...
For any simplicial complex $X$, the chain complex $W \otimes \chains(X; \F_2)$ has an $\S_2$-action concentrated in the left factor, and $\chains(X; \F_2)^{\otimes 2}$ has one given by transposition of factors.
